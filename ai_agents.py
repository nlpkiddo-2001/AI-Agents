...
class AIAgent:
    def __init__(self, api_key: str):
        ...
        self._setup_tools()
        print(f"AI Agents Initialized with {len(self.tools)} tools")
    ...
    def _setup_tools(self):
        self.tools = [
            Tool(
                name="read_file",
                description="Read the content of the files in the specified path",
                input_schema={
                    "type" : "object",
                    "properties" : {
                        "path" : {
            ...
            Tool(
                name="edit_file",
                description="Edit a file by replacing old_text with the new_text. Creates file if it doesn't exist",
                input_schema={
                    "type": "object",
                    "properties": {
                        "path": {
                        ...
                        "old_text" : {
                            "type" : "string",
                            "description" : "The text to search for and replace (leave empty to create a new file)"
                        },
                        "new_text" : {
                            "type" : "string",
    ...
    def _list_files(self, path: str) -> str:
        try:
            ...
            return f"Error listing files: {str(exception)}"
    ...
    def _edit_file(self, path: str, old_text: str, new_text: str):
        try:
            if os.path.exists(path) and old_text:
                ...
                return f"Successfully replaced {path}"
            else:
            ...
            return f"Error during editing file : {str(e)}"
